...
const std::vector<WandDirCondition> MagicWandDirMapping{
	{  0.1f,  1.0f, -0.1f,  0.1f, 0, {1.0f, 0.0f} },
	{  0.1f,  1.0f,  0.1f,  1.0f, 1, {1.0f, 1.0f} },
	{ -0.1f,  0.1f,  0.1f,  1.0f, 2, {0.0f, 1.0f} },
	{ -1.0f, -0.1f,  0.1f,  1.0f, 3, {-1.0f, 1.0f} },
	{ -1.0f, -0.1f, -0.1f,  0.1f, 4, {-1.0f, 0.0f} },
	{ -1.0f, -0.1f, -1.0f, -0.1f, 5, {-1.0f, -1.0f} },
	{ -0.1f,  0.1f, -1.0f, -0.1f, 6, {0.0f, -1.0f} },
	{  0.1f,  1.0f, -1.0f, -0.1f, 7, {1.0f, -1.0f} } 
};
